...
main_path='./'
data_path = main_path + '/dataset_arm_position'
feature_path = main_path + '/features_arm_position'
...
for repeat in range(0,Nrepeat):
    ...
    for subject in range(Nsubject):
        ...
        print('Running on subject' + str(subject))
        ...
        mdl_pretrain = joblib.load(main_path + 'model_pretrain/model_pretrain_with_66_participants.joblib')
        ...
        for idx_test_block in range(Ntesting_blocks):
        ...
        print('Accuracy of LDA in 11 testing blocks')
        print(np.mean(accuracy_standard_LDA[0:subject + 1, :], axis=0))
        print('Accuracy of RF in 11 testing blocks')
        print(np.mean(accuracy_standard_RF[0:subject + 1, :], axis=0))
        print('Accuracy of pre-trained RF in 11 testing blocks')
        print(np.mean(accuracy_pretrain[0:subject + 1, :], axis=0))
        print('Accuracy of pre-trained and fine-tuned RF in 11 testing blocks')
        print(np.mean(accuracy_prune_append[0:subject + 1, :], axis=0))
        print('Accuracy of self-calibrating RF in 11 testing blocks')
        print(np.mean(accuracy_self_calibration[0:subject + 1, :], axis=0))

        np.save(results_path + '/accuracy_standard_LDA_repeat' + str(repeat) + '.npy', accuracy_standard_LDA)
        np.save(results_path + '/accuracy_standard_RF_repeat' + str(repeat) + '.npy', accuracy_standard_RF)
        np.save(results_path + '/accuracy_pretrain_repeat' + str(repeat) + '.npy', accuracy_pretrain)
        np.save(results_path + '/accuracy_prune_append_repeat' + str(repeat) + '.npy', accuracy_prune_append)
        np.save(results_path + '/accuracy_self_calibration_repeat' + str(repeat) + '.npy', accuracy_self_calibration)
