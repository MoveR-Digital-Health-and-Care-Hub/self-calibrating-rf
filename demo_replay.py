...
for repeat in range(0,Nrepeat):
    ...
    for subject in range(Nsubject):
        ...
        np.save(results_path + '/accuracy_demo_standard_LDA_repeat' + str(repeat) + '.npy', accuracy_standard_LDA)
        np.save(results_path + '/accuracy_demo_standard_RF_repeat' + str(repeat) + '.npy', accuracy_standard_RF)
        np.save(results_path + '/accuracy_demo_pretrain_repeat' + str(repeat) + '.npy', accuracy_pretrain)
        np.save(results_path + '/accuracy_demo_prune_append_repeat' + str(repeat) + '.npy', accuracy_prune_append)
        np.save(results_path + '/accuracy_demo_self_calibration_repeat' + str(repeat) + '.npy', accuracy_self_calibration)
